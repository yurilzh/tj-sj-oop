/* 2451899 刘哲豪 计科 */
/* 2451897 吴纪凡 2453411 蔡嘉君 2454335 卢丰源 2451696 史隽博 */
...
int main()
{
    ...
    if (1) {
        ...
        cout << "erase测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
    ...
    if (1) {
        ...
        cout << "插入(insert)测试(TStringAdv类和TStringAdv类)" << endl;

        s1 = "Hello";
        s2 = "ABC";
        cout << "s1应为HeABCllo，        实际输出：" << s1.insert(s2, 3) << endl;

        s1 = "Hello";
        cout << "s1应为HelloABC，        实际输出：" << s1.insert(s2, 6) << endl;

        s1 = "Hello";
        cout << "s1应为ABCHello，        实际输出：" << s1.insert(s2, 1) << endl;

        s1 = "Hello";
        cout << "s1应为Hello，           实际输出：" << s1.insert(s2, 0) << endl;

        s1 = "Hello";
        cout << "s1应为Hello，           实际输出：" << s1.insert(s2, 100) << endl;

        s1 = "Hello";
        s2 = nullptr;
        cout << "s1应为Hello，           实际输出：" << s1.insert(s2, 3) << endl;
    ...
    if (1) {
        ...
        cout << "插入(insert)测试(TStringAdv类和字符指针)" << endl;

        s1 = "Hello";
        cout << "s1应为HeXYZllo，        实际输出：" << s1.insert(cs, 3) << endl;

        s1 = "Hello";
        cout << "s1应为HelloXYZ，        实际输出：" << s1.insert(cs, 6) << endl;

        s1 = "Hello";
        cout << "s1应为Hello，           实际输出：" << s1.insert(empty, 3) << endl;

        s1 = "Hello";
        cout << "s1应为Hello，           实际输出：" << s1.insert(cs, -1) << endl;

        s1 = "Hello";
        cout << "s1应为Hello，           实际输出：" << s1.insert(cs, 20) << endl;
    ...
    if (1) {
        ...
        cout << "插入(insert)测试(TStringAdv类和char字符)" << endl;

        s1 = "Hello";
        cout << "s1应为HeXllo，          实际输出：" << s1.insert('X', 3) << endl;

        s1 = "Hello";
        cout << "s1应为HelloX，          实际输出：" << s1.insert('X', 6) << endl;

        s1 = "Hello";
        cout << "s1应为XHello，          实际输出：" << s1.insert('X', 1) << endl;

        s1 = "Hello";
        cout << "s1应为Hel，             实际输出：" << s1.insert('\0', 4) << endl;

        s1 = "Hello";
        cout << "s1应为<EMPTY>，         实际输出：" << s1.insert('\0', 1) << endl;

        s1 = "Hello";
        cout << "s1应为Hello，           实际输出：" << s1.insert('X', 0) << endl;
    ...
    if (1) {
        ...
        cout << "子串(substr)测试(正常情况)" << endl;

        cout << "应为This，              实际输出：" << s1.substr(1, 4) << endl;
        cout << "应为is a pencil，       实际输出：" << s1.substr(6) << endl;
        cout << "应为pencil，            实际输出：" << s1.substr(11, 100) << endl;
        cout << "应为l，                 实际输出：" << s1.substr(16, 1) << endl;
    ...
    if (1) {
        ...
        cout << "子串(substr)测试(非法pos)" << endl;

        cout << "应为<EMPTY>，           实际输出：" << s1.substr(0, 3) << endl;
        cout << "应为<EMPTY>，           实际输出：" << s1.substr(-1, 3) << endl;
        cout << "应为<EMPTY>，           实际输出：" << s1.substr(100, 3) << endl;
    ...
    if (1) {
        ...
        cout << "子串(substr)测试(非法len)" << endl;

        cout << "应为<EMPTY>，           实际输出：" << s1.substr(3, 0) << endl;
        cout << "应为<EMPTY>，           实际输出：" << s1.substr(3, -5) << endl;
    ...
    if (1) {
        ...
        cout << "串1是" << s1
             << "，依次打印字符int值的结果是（有越界读，前4后3值不可信）：" << endl;
        for (i = -4; i < s1.length() + 4; i++)
            cout << int(s1.at(i)) << ' ';
        cout << endl
             << endl;
